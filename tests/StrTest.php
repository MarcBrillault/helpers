...
{
    public function testStrBase64ImageEncode()
    {
        $imageFile                 = __DIR__ . '/pixel.gif';
        $imageFileWithoutExtension = __DIR__ . '/pixel';
        $expectedContent           = "data:image/gif;base64,";

        $this->assertEquals($expectedContent, strBase64ImageEncode($imageFile));
        $this->assertEquals($expectedContent, strBase64ImageEncode($imageFileWithoutExtension));
    }
